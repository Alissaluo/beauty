...
var MOD13Q1 = ee.ImageCollection("MODIS/006/MOD13Q1"),
    ...
    MCD12Q1_006 = ee.ImageCollection("projects/pml_evapotranspiration/MCD12Q1");
...
function showmap(){
    ui.root.clear();
    var maps = [];
    var mapNames = ["satellite", "MCD12Q1_005", "MOD13Q1", "MCD12Q1_006"]; //MOD13A1
    mapNames.forEach(function(name, index) {
        ...
        if (index === 0) {
            ...
            img = MOD13Q1.select(['NDVI', 'EVI']).filter(filterDate);
